...
class TaskLogTable extends React.Component {
    ...
    async onSort(column, sortDirection) {
        await this.setState({order_by: column.selector, direction: sortDirection});
        this.loadData();
    }
    ...
    render() {
        ...
        return (
            <DataTable
                columns={[
                    {
                        ...
                        cell: row => {
                            ...
                            return (<div>
                                <span className={"text-muted"}>{m.format("YYYY-MM-DD")}</span><br/>
                    ...
                    },
                    {
                        ...
                        cell: row => {
                            const {id} = row;
                            return (<span><a href={`/horizon/tasklogs/${id}`}><FiLink /></a></span>);
                        },
                        grow: 0
                    },
                ...
                noHeader
                subHeader
                subHeaderComponent={<TaskFilterHeader onChange={this.onChangeFilter.bind(this)} />}
