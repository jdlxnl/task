  ...
  render() {
    ...
    return (
      <div className="card">
        ...
        <div className="d-flex flex-column align-items-center justify-content-center card-bg-secondary bottom-radius">
          {loading && (
            <div className="d-flex align-items-center justify-content-center card-bg-secondary p-5 bottom-radius">
              <svg
