...
trait WithTaskLogEntryPolicyGlobal
{
    /**
    ...
    {
        return $userWithRequest->hasPermissionTo("taskLogEntry.view.{$taskLogEntry->id}");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("taskLogEntry.create");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("taskLogEntry.update.{$taskLogEntry->id}");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("taskLogEntry.delete.{$taskLogEntry->id}");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("taskLogEntry.restore.{$taskLogEntry->id}");
    }

    /**
     * Determine whether the user can permanently delete the model.
     *
     * @param \Jdlx\Task\Models\TaskLogEntry $userWithRequest
     * @param \Jdlx\Task\Models\TaskLogEntry $taskLogEntry
     * @return bool
     */
